...
class AllOrderView extends GetView {
  AllOrderView({Key? key}) : super(key: key);
  final format = NumberFormat("#,##0.00", "en_US");

  @override
  Widget build(BuildContext context) {
    return GetX<AllOrderController>(
      init: AllOrderController(),
      builder: (_) {
              ...
              Container(
                ...
                child: Container(
                  ...
                  padding: EdgeInsets.only(
                      top: 60.0,
                      bottom: orderItem.orderNumber == "" ? 80.0 : 10.0),
